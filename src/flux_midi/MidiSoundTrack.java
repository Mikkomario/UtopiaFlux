...
import flux_sound.AbstractSoundTrack;
import flux_sound.Sound;

/**
 * midiSoundtrack plays a single midi using certain sets of start- and endpoints
 *
 * @author Mikko Hilpinen.
 * @since 23.8.2013.
 */
public class MidiSoundTrack extends AbstractSoundTrack
{
	// ATTRIBUTES	------------------------------------------------------
	
	private MidiSound midi;
	...
	/**
	 * Creates a new midiSoundtrack with the given information
	 *
	 * @param name The name of the track
	 * @param midi The midiSound used in the track
	 * @param loopinformations The set of looppoints
	 */
	public MidiSoundTrack(String name, MidiSound midi, 
